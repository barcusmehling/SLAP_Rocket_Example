This repository contains files and code for a rocket finite element model (FEM) case study on dynamic environment testing, first presented in *Behling, Allen, Bahr, Mayes, & DeLima, "Damage Metric-Based Vibration Testing of a Rocket Component," IMAC 2027, Orlando, Florida*. The case study applies the **Scaled Lab PSD (SLAP)** method to the removable component of the BARC system. This component was selected for its common usage and because it has multiple elastic modes below 2000 Hz, making it a rich test case.
